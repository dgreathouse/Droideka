...
/** Add your docs here. */
public class ArmDLGFeedForward {
     ...
     */
    public ArmDLGFeedForward(double ks, double kg, double kv, double ka) {
      this.ks = ks;
      this.kg = kg;
      this.kv = kv;
      this.ka = ka;
     ...
     * @param kv The velocity gain.
     */
    public ArmDLGFeedForward(double ks, double kg, double kv) {
      this(ks, kg, kv, 0);
    }
